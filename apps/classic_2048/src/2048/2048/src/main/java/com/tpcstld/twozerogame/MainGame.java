...
public class MainGame {
    ...
    private static final int startingMaxValue = RLTask.get().get("maxValue", 2048);
    ...
    final int numSquaresY = RLTask.get().get("numSquares", 4);
    final int numSquaresX = RLTask.get().get("numSquares", 4);
    @NonNull
    ...
    MainGame(@NonNull Application appContext, @NonNull MainView view) {
    ...
    private void addStartTiles() {
        ...
        RLTask.get().logExtra("grid " + Arrays.deepToString(grid.getFieldArray()));
    }
    ...
    public void move(int direction) {
        ...
        RLTask.get().logExtra("direction [" + direction + "]");
        prepareUndoState();
